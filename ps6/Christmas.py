...
Christmas = lines.filter(find).repartition(480) # 18 minutes for full
Christmas.count() # 433k observations for full dataset
...
counts = Christmas.map(stratify).reduceByKey(add) # 5 minutes
...
outputDir = '/global/home/users/cpaismz/ChristmasFull'
