...
% Load all functions
<<CitesScholar-ext, echo=FALSE, eval=TRUE, cache=FALSE>>=
@
<<DownloadfromScholar-ext, echo=FALSE, eval=TRUE, cache=FALSE>>=
@
<<CreateDataFrame-ext, echo=FALSE, eval=TRUE, cache=FALSE>>=
@
<<CreateDataFramesubset-ext, echo=FALSE, eval=TRUE, cache=FALSE>>=
@
