...
\subsubsection*{b.2) Main Script B: MetaData extraction}
\begin{itemize}
...
Thus, at this point we have a clean character object (list of lists) containing a perfect match for each speaker and text, classifieds by Plays.
