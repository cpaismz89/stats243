...
\begin{itemize}
  ...
  Clearly, this function will have a poor performance due to the number of steps, calculations, and ineficient use of a $for$ loop included. However, we are including it for comparison purposes in our analysis.
\end{itemize}
...
\begin{itemize}
  \item[6.] In order to perform the comparisons, we proceed as follows:
    \begin{itemize}
      \item[i)]  Preliminar microbenchmark tests and plot are developed comparing all functions (including the PIKKV1 poor performance function).
